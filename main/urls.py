...
urlpatterns = [
    ...
    path("competitions/<slug:slug>/matches", views.competition_matches),
    path("competitions/<slug:slug>/players", views.competition_players),
    # Scrapers
    path("scrape/competitions", ScrapeCompetitionsView.as_view()),
    path("scrape/competition_teams", scrape_competition_teams),
